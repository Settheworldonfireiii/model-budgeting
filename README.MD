...
```
python model_budgeting.py --model_name deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B --prompt "Alice and Bob are each given \$2000 to invest.
...
--mode limit-thinking --min_tokens 300 --max_tokens 800 --max_final_tokens 200 
